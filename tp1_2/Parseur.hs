...
happyReduction_11 (HappyTerminal (NOMBRE happy_var_1))
	 =  HappyAbsSyn7
		 (Num happy_var_1
	)
...
happyReduction_12 (HappyTerminal (FLOAT happy_var_1))
	 =  HappyAbsSyn7
		 (Float happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	PARENTG -> cont 13;
	PARENTD -> cont 14;
	NOMBRE happy_dollar_dollar -> cont 15;
	FLOAT happy_dollar_dollar -> cont 16;
	_ -> happyError' (tk:tks)
	}
